...
import mavlc.codegen.TAMAssembler;
...
import mavlc.codegen.CodeGeneration;
...
public class Main {
	...
	public static void main(String[] args) {
		 ...
		 * Codegen.
		 */
		TAMAssembler assembler = new TAMAssembler();
		compilationUnit.accept(new CodeGeneration(env, assembler), 0);
		Disassembler.disassembleProgram(System.out, assembler.getConstantPool(), assembler.getCode(), env.getFunctions());
		assembler.writeObjectProgram(outputFile.getAbsolutePath()); // This creates the .tam file!
